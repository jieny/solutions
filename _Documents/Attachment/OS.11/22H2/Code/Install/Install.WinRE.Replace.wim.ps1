Get-WindowsImage -ImagePath "D:\OS11\sources\install.wim" -ErrorAction SilentlyContinue | ForEach-Object {
	...
	$Arguments = @(
		...
		"$($_.ImageIndex)",
		"--command=""add 'D:\OS11_Custom\Install\Install\Update\Winlib\WinRE.wim' '\Windows\System32\Recovery\WinRe.wim'"""
	)
