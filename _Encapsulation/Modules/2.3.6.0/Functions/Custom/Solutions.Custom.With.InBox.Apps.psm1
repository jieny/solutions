				...
				AdditionalEdition = @(
					@{
						...
						Rule = @(
							...
							@{ GUID = "4ee9edf6-b084-4f3b-8125-8be49c2b9419"; Name = "Windows 10 Enterprise multi-session / Virtual Desktops"; Requiredversion = "Professional";  NewEditionId = "ServerRdsh";               Productkey = ""; Detailed = @{ ImageName = "Auto"; Description = "Auto"; DisplayName = "Auto"; DisplayDescription = "Auto"; }; }
