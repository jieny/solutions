			...
			@{
				...
				InboxApps   = @{
					...
					Rule = @(
						...
						@{ Name = "Microsoft.MinecraftEducationEdition";     Match = "MinecraftEducationEdition";         License = "MinecraftEducationEdition";         Region = ""; Dependencies = @("Microsoft.VCLibs.140.00.UWPDesktop"); }
