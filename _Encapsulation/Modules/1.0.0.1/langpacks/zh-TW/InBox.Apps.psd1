ConvertFrom-StringData -StringData @'
	...
	InboxAppsClear                  = 強行刪除已安裝的所有預應用程序 ( UWP )
	InstallUWP                      = 匹配 UWP 應用
	InstallUWPCheck                 = 檢查依賴包
	InstallUWPCheckTips             = 根據規則，獲取已選擇的所有安裝項，校驗是否已選擇所依賴的安裝項。
	LocalExperiencePackTips         = 本地語言體驗包 ( LXPs )
