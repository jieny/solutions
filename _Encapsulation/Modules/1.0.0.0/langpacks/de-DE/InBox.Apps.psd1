ConvertFrom-StringData -StringData @'
	...
	InstallUWP                      = Passen Sie UWP Apps an
	InstallUWPCheck                 = Abhängigkeiten prüfen
	InstallUWPCheckTips             = Rufen Sie gemäß den Regeln alle ausgewählten Installationselemente ab und überprüfen Sie, ob die abhängigen Installationselemente ausgewählt wurden.
	LocalExperiencePackTips         = Local Language Experience Packs ( LXPs )
