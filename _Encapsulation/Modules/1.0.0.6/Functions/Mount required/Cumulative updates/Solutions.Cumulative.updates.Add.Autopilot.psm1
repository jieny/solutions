<#
	...
	.自动驾驶：添加更新
#>
Function Update_Add_UI_Autopilot
{
	<#
		.转换架构类型
	#>
	...
	Function Refres_Event_Tasks_Update_Add_UI_Autopilot
	{
		<#
			.全局
		#>
	...
	$UI_Main           = New-Object system.Windows.Forms.Form -Property @{
		...
		Height         = 720
		Width          = 928
		Text           = "$($lang.Update): $($lang.AddTo) [ $($lang.Autopilot), $($lang.Event_Primary_Key): $($Global:Primary_Key_Image.Uid) ]"
	...
	$UI_Main_Dashboard_Event_Global_Clear = New-Object system.Windows.Forms.LinkLabel -Property @{
		...
		add_Click      = {
			...
			Refres_Event_Tasks_Update_Add_UI_Autopilot
