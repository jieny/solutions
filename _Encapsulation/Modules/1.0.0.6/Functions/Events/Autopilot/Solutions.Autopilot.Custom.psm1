...
Function Image_Assign_Autopilot_Master
{
	...
	Function Image_Select_Public_Autopilot_Add
	{
		...
		$GUIImageSelectFunctionUpdateAdd = New-Object system.Windows.Forms.LinkLabel -Property @{
			...
			Padding        = "31,0,0,0"
			Text           = $lang.AddTo
			Tag            = "Update_Add_UI_Autopilot"
			LinkColor      = "GREEN"
			ActiveLinkColor = "RED"
			LinkBehavior   = "NeverUnderline"
			add_Click      = {
				Image_Set_Global_Primary_Key -Uid $this.Parent.Name -Silent -DevCode "Autopilot - 300"

				Update_Add_UI_Autopilot
				Autopilot_Refresh_Public_Events_All
			}
		}
		$GUIImageSelectFunctionUpdateDel = New-Object system.Windows.Forms.LinkLabel -Property @{
			...
			Padding        = "31,0,0,0"
			Text           = $lang.Del
			Tag            = "Update_Delete_UI_Autopilot"
			LinkColor      = "GREEN"
			ActiveLinkColor = "RED"
			LinkBehavior   = "NeverUnderline"
			add_Click      = {
				Image_Set_Global_Primary_Key -Uid $this.Parent.Name -Silent -DevCode "Autopilot - 311"

				Update_Delete_UI_Autopilot
				Autopilot_Refresh_Public_Events_All
			}
		}
		...
		$GUIImageSelectFunctionDriveAdd = New-Object system.Windows.Forms.LinkLabel -Property @{
			...
			LinkBehavior   = "NeverUnderline"
			add_Click      = {
				Image_Set_Global_Primary_Key -Uid $this.Parent.Name -Silent -DevCode "Autopilot - 500"
	...
	Function Autopilot_Public_Event_Assign_Task_Verify
	{
		...
		if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$((Get-Module -Name Solutions).Author)\Solutions\Autopilot\Deploy\Update" -Name "$($Master)_$($ImageName)_$(Get_Autopilot_Location)_$($Global:ImageType)_Add_Auto" -ErrorAction SilentlyContinue) {
			$FlagIsWait += "Update_Add_UI_Autopilot"
		}
		...
		if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$((Get-Module -Name Solutions).Author)\Solutions\Autopilot\Deploy\Update" -Name "$($Master)_$($ImageName)_$(Get_Autopilot_Location)_$($Global:ImageType)_Del_Auto" -ErrorAction SilentlyContinue) {
			$FlagIsWait += "Update_Delete_UI_Autopilot"
		}
...
#			write-host "已挂载"
		...
		$GUIImageSelectFunctionUWPOne = New-Object system.Windows.Forms.LinkLabel -Property @{
			Height         = 35
			Width          = 450
			Padding        = "31,0,0,0"
			Text           = $lang.StepOne
		...
		$GUIImageSelectFunctionUWPTwo = New-Object system.Windows.Forms.LinkLabel -Property @{
			Height         = 35
			Width          = 450
			Padding        = "31,0,0,0"
		...
		$GUIImageSelectFunctionUWP_Update = New-Object system.Windows.Forms.LinkLabel -Property @{
			Height         = 35
			Width          = 450
			Padding        = "31,0,0,0"
		...
		$GUIImageSelectFunctionUWP_Delete = New-Object system.Windows.Forms.LinkLabel -Property @{
			Height         = 35
			Width          = 450
			Padding        = "31,0,0,0"
			...
			add_Click      = {
				...
				InBox_Apps_Remove_UI
				Autopilot_Refresh_Event_All
			}
		}
		$GUIImageSelectFunctionUWP_Match_Delete = New-Object system.Windows.Forms.LinkLabel -Property @{
			Height         = 35
			Width          = 450
			Padding        = "31,0,0,0"
				...
				$Group_Image_Sources_Console.controls.AddRange((
					$GUIImageSelectFunctionNeedMount,
						...
						$GUIImageSelectFunctionUWP,
							...
							$GUIImageSelectFunctionUWP_Update,
							$GUIImageSelectFunctionUWP_Delete,
							$GUIImageSelectFunctionUWP_Match_Delete,
	...
	Function Image_Select_Refresh_Install_Boot_WinRE_Autopilot_Export_Add
	{
		...
		if ($NewTasksFull.IsAutoSelect -contains "InBox_Apps_Mark_UI") {
			$GUIImageSelectFunctionUWPOne.Checked = $True
		}
		...
		if ($NewTasksFull.IsAutoSelect -contains "InBox_Apps_Add_UI") {
			$GUIImageSelectFunctionUWPTwo.Checked = $True
		}

		$GUIImageSelectFunctionUWP_Update = New-Object System.Windows.Forms.CheckBox -Property @{
			Name           = "IsAssign"
			Height         = 35
			Width          = 412
			Padding        = "31,0,0,0"
		...
		if ($NewTasksFull.IsAutoSelect -contains "InBox_Apps_Update_UI") {
			$GUIImageSelectFunctionUWP_Update.Checked = $True
		}
		
		$GUIImageSelectFunctionUWP_Remove = New-Object System.Windows.Forms.CheckBox -Property @{
			Name           = "IsAssign"
			Height         = 35
			Width          = 412
			Padding        = "31,0,0,0"
		...
		if ($NewTasksFull.IsAutoSelect -contains "InBox_Apps_Remove_UI") {
			$GUIImageSelectFunctionUWP_Remove.Checked = $True
		}

		$GUIImageSelectFunctionUWP_Match_Delete = New-Object System.Windows.Forms.CheckBox -Property @{
			Name           = "IsAssign"
			Height         = 35
			Width          = 412
			Padding        = "31,0,0,0"
		...
		if ($NewTasksFull.IsAutoSelect -contains "InBox_Apps_Match_Delete_UI") {
			$GUIImageSelectFunctionUWP_Match_Delete.Checked = $True
		}
		...
		if ($NewTasksFull.IsAutoSelect -contains "Update_Add_UI") {
		...
		if ($NewTasksFull.IsAutoSelect -contains "Update_Delete_UI") {
	...
	#			write-host "已挂载"
		...
		$MarkUwpGroup = $False
		if ($Tasks -contains "InBox_Apps_Mark_UI") { $MarkUwpGroup = $True }
		if ($Tasks -contains "InBox_Apps_Add_UI") { $MarkUwpGroup = $True }
		if ($Tasks -contains "InBox_Apps_Update_UI") { $MarkUwpGroup = $True }
		if ($Tasks -contains "InBox_Apps_Match_Delete_UI") { $MarkUwpGroup = $True }
	
		if ($MarkUwpGroup) {
			$Group_Image_Sources_Console.controls.AddRange($GUIImageSelectFunctionUWP)
	
			if ($Tasks -contains "InBox_Apps_Mark_UI") { $Group_Image_Sources_Console.controls.AddRange($GUIImageSelectFunctionUWPOne) }
			if ($Tasks -contains "InBox_Apps_Add_UI") { $Group_Image_Sources_Console.controls.AddRange($GUIImageSelectFunctionUWPTwo) }
			if ($Tasks -contains "InBox_Apps_Update_UI") { $Group_Image_Sources_Console.controls.AddRange($GUIImageSelectFunctionUWP_Update) }
			if ($Tasks -contains "InBox_Apps_Remove_UI") { $Group_Image_Sources_Console.controls.AddRange($GUIImageSelectFunctionUWP_Remove) }
			if ($Tasks -contains "InBox_Apps_Match_Delete_UI") { $Group_Image_Sources_Console.controls.AddRange($GUIImageSelectFunctionUWP_Match_Delete) }

			$Group_Image_Sources_Console.controls.AddRange($GUIImageSelectFunctionUWP_Wrap)
		}

		$MarkUpdateGroup = $False
		if ($Tasks -contains "Update_Add_UI") {  $MarkUpdateGroup = $True }
		if ($Tasks -contains "Update_Delete_UI") { $MarkUpdateGroup = $True }
	
		if ($MarkUpdateGroup) {
			$Group_Image_Sources_Console.controls.AddRange($GUIImageSelectFunctionUpdate)
	
			if ($Tasks -contains "Update_Add_UI") {  $Group_Image_Sources_Console.controls.AddRange($GUIImageSelectFunctionUpdateAdd) }
			if ($Tasks -contains "Update_Delete_UI") { $Group_Image_Sources_Console.controls.AddRange($GUIImageSelectFunctionUpdateDel) }
	...
	Function Refresh_Prerequisite_Sources
	{
		...
		if (Test-Path -Path $itemISO -PathType Container) {
			...
			$itemISO = Join-Path -Path $itemISO -ChildPath "_Autopilot" -ErrorAction SilentlyContinue
		}
	...
	Function Refresh_Config_Rule_Sync_To_Show
	{
		...
		$UI_Main_Export_Event_Custom_Menu.controls.AddRange($Autopilot_Assign_Menu_ISO_Associated_Schemes_Show)
			...
			Get-ChildItem -Path "$($MainSources)\_ISO" -Directory -ErrorAction SilentlyContinue | ForEach-Object {
				$NewEnglinePath = Convert-Path "$($PSScriptRoot)\..\..\..\..\.." -ErrorAction SilentlyContinue
				$TempFilePath = Join-Path -Path $NewEnglinePath -ChildPath "\_Custom\Engine" -ErrorAction SilentlyContinue
				$NewGroupName = [IO.Path]::GetFileNameWithoutExtension($_.FullName)
		...
		$UI_Main_Export_Event_Custom_Menu.controls.AddRange($GUIImageSelectEventNeedMount)
			...
			if ([string]::IsNullOrEmpty($Autopilot.Deploy.ImageSource.Tasks.Convert)) {
				...
				$Install_swm = Join-Path -Path $Global:Image_source -ChildPath "Sources\install.swm" -ErrorAction SilentlyContinue
				$Install_ESD = Join-Path -Path $Global:Image_source -ChildPath "Sources\install.esd" -ErrorAction SilentlyContinue
				$Install_wim = Join-Path -Path $Global:Image_source -ChildPath "Sources\install.wim" -ErrorAction SilentlyContinue
	...
	Function Refresh_Config_Rule_Global
	{
		...
		#>
			...
			if (-not [string]::IsNullOrEmpty($NewTasks.Tasks.InBoxApps.Mark)) {
				$Wait_Assign_To_New_Button += "InBox_Apps_Mark_UI"
			}
			...
			if (-not [string]::IsNullOrEmpty($NewTasks.Tasks.InBoxApps.Update)) {
				$Wait_Assign_To_New_Button += "InBox_Apps_Update_UI"
			}
			...
			if (-not [string]::IsNullOrEmpty($NewTasks.Tasks.InBoxApps.Remove)) {
				$Wait_Assign_To_New_Button += "InBox_Apps_Remove_UI"
			}
		...
		#>
			...
			if (-not [string]::IsNullOrEmpty($NewTasks.Tasks.CumulativeUpdate.Add)) {
				$Wait_Assign_To_New_Button += "Update_Add_UI"
			}
			...
			if (-not [string]::IsNullOrEmpty($NewTasks.Tasks.CumulativeUpdate.Del)) {
				$Wait_Assign_To_New_Button += "Update_Delete_UI"
			}
...
#			Refresh_Config_Rule_Sync_To_Show
	...
	Function Autopilot_Event_Assign_Task_Verify
	{
		...
		<#
			.本地语言体验包：标记
		#>
		if ((Get-Variable -Scope global -Name "Queue_Is_InBox_Apps_Mark_UI_$($Master)_$($ImageName)" -ErrorAction SilentlyContinue).Value) {
			$FlagIsWait += "InBox_Apps_Mark_UI"
		}
		...
		if ($Temp_Queue_Is_InBox_Apps_Update.Count -gt 0) {
			$FlagIsWait += "InBox_Apps_Update_UI"
		}
		...
		if ($Temp_LXPs_Delete.Count -gt 0) {
			$FlagIsWait += "InBox_Apps_Remove_UI"
		}
	...
	Function Refresh_All_Rule_Guid
	{
		...
		if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$((Get-Module -Name Solutions).Author)\Solutions" -Name "DiskTo" -ErrorAction SilentlyContinue) {
			...
			$NewSources_ISO = Join-Path -Path $itemISO -ChildPath $Global:Init_Search_ISO_Folder_Name -ErrorAction SilentlyContinue
		}
...
Function Autopilot_Refresh_Export_Event_To_WIM
{
	...
	#>
		<#
			.第一步：标记
		#>
		if ($SelectEvent -contains "InBox_Apps_Mark_UI") {
			Write-Host "`n   $($lang.LanguageExtractAddTo): $($lang.StepOne)" -ForegroundColor Yellow
			Write-host "   $('-' * 80)"
			InBox_Apps_Mark_UI -Autopilot $NewTasks.Tasks.InBoxApps.Mark
		}
		...
		if ($SelectEvent -contains "InBox_Apps_Add_UI") {
			Write-Host "`n   $($lang.LanguageExtractAddTo): $($lang.StepTwo): $($lang.AddTo)" -ForegroundColor Yellow
			Write-host "   $('-' * 80)"
		...
		<#
			.更新
		#>
		if ($SelectEvent -contains "InBox_Apps_Update_UI") {
			Write-Host "`n   $($lang.LanguageExtractAddTo): $($lang.LocalExperiencePackTips): $($lang.Update)" -ForegroundColor Yellow
			Write-host "   $('-' * 80)"
			InBox_Apps_Update_UI -Autopilot $NewTasks.Tasks.InBoxApps.Update
		}

		<#
			.删除
		#>
		if ($SelectEvent -contains "InBox_Apps_Remove_UI") {
			Write-Host "`n   $($lang.LanguageExtractAddTo): $($lang.LocalExperiencePackTips): $($lang.Del)" -ForegroundColor Yellow
			Write-host "   $('-' * 80)"
			InBox_Apps_Remove_UI -Autopilot $NewTasks.Tasks.InBoxApps.Remove
		}
	...
	#>
		<#
			.添加
		#>
		if ($SelectEvent -contains "Update_Add_UI") {
			Write-Host "`n   $($lang.LanguageExtractAddTo): $($lang.Update): $($lang.AddTo)" -ForegroundColor Yellow
			Write-host "   $('-' * 80)"
			Autopilot_Update_Add_UI_Import -Tasks $NewTasks.Tasks.CumulativeUpdate.Add
		}

		<#
			.删除
		#>
		if ($SelectEvent -contains "Update_Delete_UI") {
			Write-Host "`n   $($lang.LanguageExtractAddTo): $($lang.Update): $($lang.Del)" -ForegroundColor Yellow
			Write-host "   $('-' * 80)"
			Autopilot_Update_Delete_UI_Import -Tasks $NewTasks.Tasks.CumulativeUpdate.Del
		}
