ConvertFrom-StringData -StringData @'
	...
	InboxAppsClear                  = 설치된 모든 사전 앱 (UWP) 을 강제로 제거
	InstallUWP                      = UWP 앱 일치
	InstallUWPCheck                 = 종속성 확인
	InstallUWPCheckTips             = 규칙에 따라 선택한 설치 항목을 모두 가져오고 종속 설치 항목이 선택되었는지 확인합니다.
	LocalExperiencePackTips         = 현지 언어 체험 팩 (LXPs)
