...
$Global:Preconfigured_Rule_Language = @(
	...
	@{
		...
		ISO         = @(
			@{
				ISO = "en-us_windows_server_2025_preview_x64_dvd_ce9eb1a5.iso"
				CRCSHA = @{
					SHA256 = ""
					SHA512 = ""
				}
		...
		Language = @{
			ISO = @(
				@{
					ISO = "mul_languages_and_optional_features_for_windows_server_2025_preview_x64_dvd_762b4771.iso"
					CRCSHA = @{
						SHA256 = ""
						SHA512 = ""
					}
