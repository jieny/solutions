...
Function Setting_UI
{
	...
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Suite\Update" -Name "AutoCheckUpdate_Hours" -ErrorAction SilentlyContinue) {
		$GUIImageSourceSettingUP_Auto_Adv_Auto_Check_Setting.Value = Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Suite\Update" -Name "AutoCheckUpdate_Hours" -ErrorAction SilentlyContinue
	} else {
