...
#				"9559adbe-95f3-4cc1-ad3e-fd3189d093aa"    # Google Chrome Canary
				"a1f51cf8-32c8-431c-8b2e-f7f8ad208863"    # 7Zip
				"fff5fb9c-1ee2-4e74-865e-7e416ef13b68"    # WinRAR
			)

			& $DynamicInstl -Config "$($PSScriptRoot)\..\..\..\langpacks\$($Global:IsLang)\App.json" -App $init_Install_App
		} else {
